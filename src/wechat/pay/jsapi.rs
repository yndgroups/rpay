...
use crate::{constant::V3_PAY_TRANSACTIONS_JS_API, core::common::RPayResponse, model::{Amount, Detail, Payer, SceneInfo, SettleInfo, SignData}, utils, RPayResult};
...
/// 创建请求
impl JsApiPay {
    pub async fn pay(&mut self, wechat_sdk: WechatV3PayConfig) -> RPayResult<JsapiResponse> {
        ...
        utils::build_request::<JsapiResponse>(wechat_sdk,crate::common::HttpMethod::POST, V3_PAY_TRANSACTIONS_JS_API, json_body).await
    }
}
...
impl RPayResponse for JsapiResponse {}
