...
use crate::{constant::V3_PAY_TRANSACTIONS_APP, core::common::RPayResponse, model::{Amount, Detail, Payer, SceneInfo, SettleInfo, SignData}, utils, RPayResult};
...
impl AppPay {
     pub async fn pay(&mut self, wechat_sdk: WechatV3PayConfig) -> RPayResult<AppResponse> {
        ...
        utils::build_request::<AppResponse>(wechat_sdk,crate::common::HttpMethod::POST, V3_PAY_TRANSACTIONS_APP, json_body).await
    }
}
